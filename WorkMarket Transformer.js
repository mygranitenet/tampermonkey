...
(async function() {
    ...
    class WorkMarketTransformer {
        ...
        _createMainOverlay() { if (document.getElementById('wmTransformerOverlay')) return; this.mainOverlay = document.createElement('div'); this.mainOverlay.id = 'wmTransformerOverlay'; this.mainOverlay.className = 'wm-transformer-overlay'; this.mainOverlay.innerHTML = `<div class="overlay-header"><span>WorkMarket Enhanced Assignments</span><div class="overlay-controls"><button class="overlay-refresh-btn overlay-icon-btn" title="Refresh Data">🔄</button><button class="overlay-clear-filters-btn" title="Clear Filters">Clear</button><button class="copy-json-btn" title="Copy as JSON">JSON</button><button class="copy-csv-btn" title="Copy as CSV">CSV</button><button class="download-csv-btn overlay-icon-btn" title="Download CSV">📥</button><button class="overlay-close-btn overlay-icon-btn" title="Hide">X</button></div></div><div class="overlay-content"></div><div class="overlay-resize-handle"></div>`; document.body.appendChild(this.mainOverlay); this.mainOverlay.querySelector('.overlay-refresh-btn').addEventListener('click', () => document.getElementById('btn-search-assignments')?.click()); this.mainOverlay.querySelector('.overlay-clear-filters-btn').addEventListener('click', () => this._clearFilters()); this.mainOverlay.querySelector('.copy-json-btn').addEventListener('click', () => this._copyJsonToClipboard()); this.mainOverlay.querySelector('.copy-csv-btn').addEventListener('click', () => this._copyCsvToClipboard()); this.mainOverlay.querySelector('.download-csv-btn').addEventListener('click', () => this.exportDataToCsv()); this.mainOverlay.querySelector('.overlay-close-btn').addEventListener('click', () => this.mainOverlay.style.display = 'none'); }
